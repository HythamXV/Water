...
model = pickle.load(open(r"D:\DAZEMIND USER\Downloads\Haitham\Final Project\mushbari-main\mushbari-main\project water24\RandomForestClassifier_model2.sav", 'rb'))
...
if st.button('Predict Potability'):
    ...
    if prediction[0] == 0:
        st.error('The water is not potable. Please consider water treatment.')
    else:
        st.success('Congratulations! The water is potable.')
